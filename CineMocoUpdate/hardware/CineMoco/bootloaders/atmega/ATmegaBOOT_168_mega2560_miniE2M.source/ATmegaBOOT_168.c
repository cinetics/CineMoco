...
//*	added by Mark Sproul, June 7, 2010
#ifdef BLUETOOTH
...
//		putch(0x0A);
	...
	#if defined __AVR_ATmega168__  || __AVR_ATmega328P__ || __AVR_ATmega128__ || __AVR_ATmega1280__ || __AVR_ATmega1281__ || __AVR_ATmega2560__
		...
		#elif defined(CEREBOTPLUS)
					welcome	=	"ATmegaBOOT / Arduino cerebot - (C) Arduino LLC modified by MLS - 100423\n\r";
